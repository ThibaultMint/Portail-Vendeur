...
# Charger les variables d'environnement depuis velo-mailer/.env ou .env.local
script_dir = Path(__file__).parent.parent
env_path = script_dir / ".env"
env_local_path = script_dir / ".env.local"

# Priorité : .env.local puis .env
if env_local_path.exists():
    load_dotenv(env_local_path)
    print(f"✅ Fichier chargé: {env_local_path}")
elif env_path.exists():
    load_dotenv(env_path)
    print(f"✅ Fichier chargé: {env_path}")
else:
    print(f"⚠️  Aucun fichier .env trouvé, utilisation des valeurs par défaut")

# Utiliser les mêmes valeurs que supabaseClient.js
SUPABASE_URL = os.getenv("SUPABASE_URL") or os.getenv("REACT_APP_SUPABASE_URL") or "https://tddvzukomkujcykmeaar.supabase.co"
SUPABASE_KEY = os.getenv("SUPABASE_KEY") or os.getenv("REACT_APP_SUPABASE_ANON_KEY") or "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkZHZ6dWtvbWt1amN5a21lYWFyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcwNTQzMDAsImV4cCI6MjA3MjYzMDMwMH0._0QSHzVkdh4xI6GvmdrMLt5jD-sMqYtBlag2GUalm94"
